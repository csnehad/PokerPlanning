...
import com.pokerrestapi.req.AddUserStoryRequest;
...
public class UserStoryController {
	...
	public void deleteUserStory(@RequestParam String uStoryId) {
		try {
			...
			throw new RuntimeException(" Exception Occured during delete userstory  "+uStoryId);
		}
	}
	...
	public UserStory getUserStory(@RequestParam String uStoryId) {
		try {
			...
			if(userStory == null)
				throw new RuntimeException(" UserStory not found for user story id: "+uStoryId);
			return userStory;
